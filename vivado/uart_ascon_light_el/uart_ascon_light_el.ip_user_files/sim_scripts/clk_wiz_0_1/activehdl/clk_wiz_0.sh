...
#
# Script generated by Vivado on Fri Mar 21 16:46:50 +0100 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/eleves/Downloads/uart_ascon_light_el/uart_ascon_light_el.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
