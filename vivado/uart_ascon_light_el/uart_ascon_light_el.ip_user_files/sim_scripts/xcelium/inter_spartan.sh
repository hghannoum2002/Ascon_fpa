...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../uart_ascon_light_el.gen/sources_1/ip/clk_wiz_1" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.inter_spartan xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.inter_spartan -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log inter_spartan_sc.so .tmp_log xcelium_lib waves.shm c.obj)
