...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../uart_ascon_light_el.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../uart_ascon_light_el.gen/sources_1/ip/ila_0/hdl/verilog" \
