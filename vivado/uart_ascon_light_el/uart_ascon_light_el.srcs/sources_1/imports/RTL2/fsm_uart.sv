...
(
  ...
  typedef enum {
    ...
    ///add states to parse associate data // mmm
    init_ad,
    idle_ad0,
    idle_ad1,
    get_ad0,
    ...
    //add states to parse ecg wave // mmm
    init_wave,
    idle_wave0,
    idle_wave1,
    get_wave0,
    ...
    //send the cipher result all the cipher wave // mmm
    init_cipher,
    start_cipher,
    send_cipher,
...
//add register to store associated data  // mmm
ad_reg ad_reg_0(
    .clock_i(clock_i),   
    .resetb_i(resetb_i),  
    .data_i(ad_reg_s),
...
//add register to stare the plain ECG wave // mmm
wave_reg wave_reg_0(
    .clock_i(clock_i),  
    .resetb_i(resetb_i),  
    .data_i(wave_reg_s),
...
//add the register that send the tag // mmm
tag_reg tag_reg_0(
      .clock_i(clock_i),   
      .resetb_i(resetb_i),  
      .tag_i(Tag_i),
    ...
    case (etat_p)
      ...
      if (TxBusy_i == 1'b0) begin
        case (RxData_i)
          ...
          //ascii code for associate data command   // mmm
          8'h41:    etat_f = init_ad; //A
          8'h61:    etat_f = init_ad; //a

          //ascii code for ecg wave command    // mmm
          ...
          8'h54:   etat_f = init_tag;  //T         // mmm
          8'h74:   etat_f = init_tag;  //t         // mmm 
          
          8'h43:   etat_f = init_cipher;  //C      // mmm
          8'h63:   etat_f = init_cipher;  //c      // mmm
